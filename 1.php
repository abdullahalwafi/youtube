...
<header>
	<pre>
<H1><center> <font color="red">[!] Hacked By? ./WXL582GHOST [!]</font><br><br>
<center> <img src="https://3.top4top.net/p_1454rg2mn0.gif" height="400"> </h1><center> <br>
    <br> 
    <font color="white" face="Shadows Into Light" size="5"><font color="red">[</font> ! <font color="red">]</font> Sahabat? Hanya sebuah kata tak bermakna:"<font color="red">[</font> ! <font color="red">]</font></font> 
    <p>  <font color="white" face="Shadows Into Light" size="5"><font color="red">[</font> ! <font color="red">]</font> Mungkin dlu aku seperti Spongebob ataupun seperti patrik, <br>Tapi sekarang aku mencoba untuk menjadi Squidward saja. Karena itu lebih baik<font color="red">[</font> ! <font color="red">]</font></font> </center>
 <iframe width="0" height="0" src="https://5.top4top.net/m_1454an41b0.mp3" frameborder="0" loop="true" allow="" fullscreen=""></iframe> 
    <center>
     <font color="red" face="Shadows Into Light" size="5">&lt;[ Friends Of Cyber ]&gt;</font>
    </center>
    <center>
     <font size="5" face="Shadows Into Light" color="white">Official Member:</font> 
     <hr color="red"> 
     <font color="white">Dark Fighter - Zy - Naufal - /fakeroot - ./WXL582GHOST - Mr ProAL - ¤{GSOH}ツXBumbbleB33ツ - IR.DRS.PROF.MR.G0Y4N9,sch.id <br>- Demons - Mr_Vektor04 - Shuuzero7 - Sandy Vrayoga - MicroClone - Erick </font>
          <hr color="red"> 
